...
6. If you did everything correct, https://test.github.io/test/ will lead to your new docs
...
- Documentation(ReDoc): https://test.github.io/test/
- SwaggerUI: https://test.github.io/test/swagger-ui/
- Look full spec:
    + JSON https://test.github.io/test/swagger.json
    + YAML https://test.github.io/test/swagger.yaml
- Preview spec version for branch `[branch]`: https://test.github.io/test/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://test.github.io/test/ with url from the message: `Server started <url>`
